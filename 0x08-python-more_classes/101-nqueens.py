#!/usr/bin/python3
"""101-nqueens loooks for all possible solutions the N queens puzzle,
translations and reflections included.

Trying to virtual backtrack without recursion. In local tests process will
